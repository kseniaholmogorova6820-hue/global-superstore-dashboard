...
![Страница Sales](screenshots/sales-overview.png)
...
![Таблица по подкатегориям](screenshots/subcategory-table.png)
...
![Страница Shipping costs](screenshots/shipping-overview.png)

Прибыль с заказа против стоимости доставки по городам, и доля опозданий по приоритету заказа.

![Города и приоритеты](screenshots/city-and-priority.png)
